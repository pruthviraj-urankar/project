...
private $var = 0;
 ...
 function connectDatabase(){
  ...
  function updateDB(){
    $query  = "UPDATE producer SET  fname = '$this->first_name' , lname ='$this->last_name',mname =  '$this->middle_name', mobile = '$this->ph_number', land_line = '$this->land_line',door_no = '$this->addr_doorno' , area = '$this->addr_area', taluk = '$this->addr_taluk', state = '$this->state',district = '$this->district' ";
     if(mysqli_query($this->db, $query))
