...
class secondPage {
	private $chkbox;  private $year_est;
	private $rear_h_own;		private $dd_no;
	private $gar;						private $dd_date;
	private $capacity;			private $other;
	private $New_plant;
	private $chkNew;
	private $db ;
	private $app_type;
	...
	//		echo "  Capasity ==:".$this->capacity;
		...
		private function updateDatabase(){
  		...
  		$query = "UPDATE producer SET sector = '$this->chkNew',app_type = '$this->app_type' ,
		 house_owner = '$this->rear_h_own', other_details ='$this->other', dd_number = '$this->dd_no', dd_date = '$this->dd_date',year_estab = '$this->year_est',
		  ...
		  host_plant_2 = '$this->New_plant' WHERE mobile = '$this->ph_number '  ";
